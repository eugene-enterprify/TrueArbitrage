...
- [ ] 0. Git: ініціалізація репозиторію, remote на GitHub, збереження `PLAN.md` у проєкті, перший коміт і push
- [ ] 1. Каркас проєкту: venv, залежності, конфіг, `.env` з токеном, `.gitignore`
- [ ] 2. Адаптери бірж: WS-підключення з reconnect, зіставлення спільних пар з нормалізацією множників (1000x), кеш bid/ask з часовими мітками; періодичне (раз на ~5 хв) REST-оновлення funding rates і обсягів 24h (OKX — конвертація в USDT)
- [ ] 3. SpreadEngine + SQLite: розрахунок спредів по всіх парах з фільтром застарілих котирувань, запис в історію (семплінг: запис при зміні спреду понад 0.1% або раз на хвилину, щоб база не розпухала)
- [ ] 4. Telegram-бот: сповіщення з антиспамом, усі команди, health-повідомлення про втрату/відновлення з'єднань, runtime-зміна налаштувань без перезапуску
- [ ] 5. Чистий спред: комісії + фандинг у розрахунку і в тексті сповіщення
- [ ] 6. Запуск і перевірка на живих даних: звірити 2–3 пари вручну з сайтами бірж, тимчасово знизити поріг до 0.3–0.5% щоб побачити живі сповіщення, перевірити `/export`
