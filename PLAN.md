...
- [x] 6. Запуск і перевірка на живих даних: BTC-спред звірено (0.002–0.006%, коректно), чат зареєстровано через /start, /status і /top працюють, чистий спред правильно враховує комісії
